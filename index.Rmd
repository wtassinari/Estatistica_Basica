...
Esta página representa o repositório do conteúdo das disciplinas de Estatística Básica e Introdução à Bioestatística - 2021-1 (DEMAT/UFRRJ)
...
|   Data    |             Descrição             | Aulas |      |   Data    |                    Descrição                     | Aulas |
| :-------: | :-------------------------------: | :---: | ---- | :-------: | :----------------------------------------------: | :---: |
| **20/09** |  `r colFmt("Apresentação da  Disciplina*",'blue')`  |   -   |      | **03/11** |  Introdução à Probabilidade  |   8   |
...
| **11/10** | `r colFmt("Medidas de Posição*",'blue')`         |   4   |      | **29/11** | Distribuições de Probabilidade para VA contínuas |  11   |
| **13/10** | Medidas de Dispersão e Assimetria | 5 e 6 |      | **01/12** | `r colFmt("Distribuições de Probabilidade para VA contínuas*",'blue')` |  11   |
| **18/10** |`r colFmt("Medidas de Dispersão e Assimetria*",'blue')` | 5 e 6 |      | **06/12** |       Introdução à Inferência Estatística        |  12   |
| **20/10** |       Análise Bidimensional       |   7   |      | **08/12** |  `r colFmt("Introdução à Inferência Estatística*",'blue')`                      |  12   |
| **25/10** | `r colFmt("Análise Bidimensional*",'blue')`       |   7   |      | **13/12** |     `r colFmt("P2**",'red')`        |       |
| **27/10** | `r colFmt("Aula de Dúvidas*",'blue')`       |   7   |      | **15/12** |     `r colFmt("Segunda chamada**",'red')`        |       |
| **01/11** |  `r colFmt("P1**",'red')`             |       |      | **20/12** |  `r colFmt("Optativa**",'red')`                       |       |
...
| Síncrona | Atividades síncronas a respeito da Aula 8 | [link](https://www.dropbox.com/s/qfx9y19qoyn3879/Aula8_sincrona_feita2.pdf?dl=0) |
...
| Síncrona | Atividades síncronas a respeito da Aula 9 | [link](https://www.dropbox.com/s/2l7t2hyusyx6n42/Aula9_sincrona_feita2.pdf?dl=0)  |
...
| Assíncrona | Videoaula sobre a Aula 10 - Vídeo 2 |  [link](https://drive.google.com/file/d/1Jk2HpumrpQ-N69soV_qbTDc6H3GfNpGI/view?usp=sharing)  |
...
| Síncrona | Atividades síncronas a respeito da Aula 10 | [link](https://www.dropbox.com/s/9j837n943e7ojdo/Aula10_sincrona_feita.pdf?dl=0) |
...
| Síncrona | Atividades síncronas a respeito da Aula 11 | [link](https://www.dropbox.com/s/chhqj10rsuilywm/Aula11_sincrona_feita2.pdf?dl=0) |
...
| Síncrona | Atividades síncronas a respeito da Aula 12 | [link](https://www.dropbox.com/s/en799ok3kttl837/Aula12_sincrona_feita2.pdf?dl=0) |
